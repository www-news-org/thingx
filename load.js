/*
	...
	-
	By Osvaldas Valutis, thingx.adball.tech
	Available for use under the MIT License
*/

;( function( root, factory )
{
	var pluginName = 'thingx';
...
}( this, function( pluginName )
{
	...
	var scriptUrl		= '//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js',
		...
		initAds = function()
		{
			...
			adsToLoad.forEach( function( ad )
			{
				...
				ad._thingxData.width	= getAdWidth( ad );
		...
		resizeAds = function()
		{
			...
			{
				if( ad._thingxData.width != getAdWidth( ad ))
				{
					anyNew			= true;
					adsLoaded		= removeAdFromList( adsLoaded, ad );
					ad.innerHTML	= ad._thingxData.originalHTML;
					adsToLoad.push( ad );
				}
			});
			if( anyNew ) initAds();
	...
	Plugin.prototype =
	{
		destroy: function()
		{
			...
			{
				entry.thingx( 'destroy' );
			});
		}
	};

	window.thingxConfig = function( options )
	{
